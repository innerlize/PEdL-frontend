	...
	return (
		<div
			...
			<div
				...
				className='flex flex-col items-center justify-center bg-white rounded-[3px] py-[15px]'>
				<div className='flex flex-col items-center justify-center gap-5 w-full h-full'>
					<div className='flex flex-col items-center justify-center gap-2.5'>
						<div>
							<PiWarningDiamondFill className='size-[50px] text-warning' />
						</div>

						<div
							data-test='confirm-modal-text'
							className='font-semibold text-xl text-center leading-6 tracking-tight'>
							{content}
						</div>
					</div>
					...
					<div
						...
						className='flex gap-[30px] font-semibold'>
						<button
							data-test='confirm-modal-cancel-button'
							className='w-[100px] h-[40px] rounded-[3px] text-neutral underline'
							onClick={hideModal}>
							Cancel
						</button>
						...
						<button
							...
							className='flex justify-center items-center w-[100px] h-[40px] bg-warning rounded-[3px] text-white transition-colors hover:bg-red-500'
